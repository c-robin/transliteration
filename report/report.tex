...
Les résultats pour l'\emph{Espagnol-Portugais} sont moins bons qu'avec l'approche basée sur les règles de substitution. Les résultats avec l'\emph{Anglais-Russe} sont comparativement bons, compte tenu de la difficulté de translittération sur deux alphabets si différents.
