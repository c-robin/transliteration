...
\begin{frame}
	...
	\begin{block}{Definition}
	    \begin{itemize}
	    \item Remplacement d'un graphème d'un système d'écriture par un ou plusieurs graphèmes d'un autre système d'écriture
    		\item Indépendent de la prononciation
    		\end{itemize}
    \end{block}	    
